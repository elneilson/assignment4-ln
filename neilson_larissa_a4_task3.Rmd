...
did_exp <- rep(0, 22)
did_not_exp <- rep(1, 14)

# Combine vectors; results in: n = 36, 22 = "0" aka did personally experience exclusionary, offensive, hostile or intimidating conduct, and 14 = "1" aka did not experience this
...
ggplot(data = studyboot_10k_df, aes(x = bs_prop)) +
  geom_histogram(bins = 22, fill = "darkslategray") +
...
For a 95% confidence interval, we expect that the true proportion of the genderqueer/nonbinary UCSB students experiencing exclusionary behavior is between 0.22 and 0.55 (bootstrap percentile interval).
